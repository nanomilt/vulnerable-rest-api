...
router.get('/:id', async (req, res) => {
    ...
    res.render('book', { book }); // Render a template with the book data
})
...
router.put('/:id', auth, async (req, res) => {
    ...
    res.render('book', { book }); // Render a template with the updated book data
})
...
router.delete('/:id', auth, async (req, res) => {
    ...
    res.render('book', { book }); // Render a template with the deleted book data
})
