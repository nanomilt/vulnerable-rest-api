...
router.put('/:id', [auth, validateObjectId], async(req, res)=>{
    ...
    res.render('update', {status: 'Updated', domain}); // Fixed: Use res.render() to render safely escaped HTML
})
...
router.post('/otp', async(req,res)=>{
    ...
    const host = process.env.HOST || req.hostname; // Replace environment variable with process.env.VARIABLE_NAME
